...
sys.path.append(r"F:\PYTORCH\deeplabv3")
...
sys.path.append(r"F:\PYTORCH\deeplabv3\model")
from deeplabv3 import DeepLabV3

sys.path.append(r"F:\PYTORCH\deeplabv3\utils")
...
network = DeepLabV3("eval_seq_thn", project_dir=r"F:\PYTORCH\deeplabv3").cuda()
#network.load_state_dict(torch.load(r"F:\PYTORCH\deeplabv3\pretrained_models\model_13_2_2_2_epoch_580.pth"))
network.load_state_dict(torch.load(r"F:\PYTORCH\deeplabv3\training_logs\model_1\checkpoints\model_1_epoch_289.pth"))


val_dataset = DatasetThnSeq(thn_data_path=r"F:\PYTORCH\deeplabv3\data\thn")
